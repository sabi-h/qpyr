import pytest
from qrcode.draw import _get_alignment_pattern_coords, get_alignment_patterns
...
def test_get_alignment_patterns():
    # fmt: off
    assert get_alignment_patterns([]) == []
    assert get_alignment_patterns([6, 34]) == [(34, 34)]

    assert get_alignment_patterns([6, 34, 62]) == [(6, 34), (34, 6), (34, 34), (34, 62), (62, 34), (62, 62)]

    coords = [6, 34, 62, 90]
    positions = [(6, 34), (6, 62), (34, 6), (34, 34), (34, 62), (34, 90), (62, 6), (62, 34), (62, 62), (62, 90), (90, 34), (90, 62), (90, 90)]
    assert get_alignment_patterns(coords) == positions
